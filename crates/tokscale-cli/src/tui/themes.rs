    ...
    pub fn from_name(name: ThemeName) -> Self {
        let colors = match name {
            ...
            ThemeName::Halloween => [
                ...
                Color::Rgb(200, 50, 0),   // grade4: dark crimson-orange (visible on dark bg)
            ],
            ThemeName::Teal => [
                Color::Rgb(22, 27, 34),    // grade0: empty
            ...
            ThemeName::Monochrome => [
                Color::Rgb(22, 27, 34),    // grade0: empty
                Color::Rgb(100, 100, 100), // grade1: dark gray (visible on dark bg)
                Color::Rgb(145, 145, 145), // grade2: medium gray
                Color::Rgb(190, 190, 190), // grade3: light gray
                Color::Rgb(220, 220, 220), // grade4: near-white (most active, most visible)
            ],
            ThemeName::YlGnBu => [
                Color::Rgb(22, 27, 34),    // grade0: empty
